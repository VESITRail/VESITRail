...
export const guide: Guide[] = [
  {
    ...
    description:
      "Start by logging into your account or registering with your student details and travel preferences.",
  },
  {
    icon: ClipboardList,
  ...
  },
  {
    ...
    description:
      "Choose whether you're applying for a fresh concession or renewing an existing one.",
  },
  {
    icon: Send,
