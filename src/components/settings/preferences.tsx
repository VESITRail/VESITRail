			...
			<div id="concession-preferences" className="mb-6 space-y-6">
				<div>
					...
					<p className="text-sm text-muted-foreground">
						Update your preferred concession class and period. These will be used as defaults when applying for
						concessions.
					</p>
				</div>
					...
					<CardContent className="py-4">
						<div className="flex flex-col items-center justify-center min-h-50 space-y-4">
							...
							<div className="text-center space-y-2">
								<h3 className="text-lg font-medium text-foreground">Unable to Load Preferences</h3>
								<p className="text-sm text-muted-foreground max-w-md">
									We couldn&apos;t load your preferences at the moment. This might be due to a temporary network issue.
								</p>
							</div>
