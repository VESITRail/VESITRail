...
export const ThemeToggle = ({ className, duration = 400 }: ThemeToggleProps) => {
	...
	return (
		<Button size="icon" ref={buttonRef} variant="outline" onClick={toggleTheme} className={className}>
