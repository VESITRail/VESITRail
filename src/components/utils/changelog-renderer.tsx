			...
			<div className={className}>
				<ReactMarkdown
					components={{
						...
						p: ({ children }) => <p className="leading-relaxed mb-1 text-foreground">{children}</p>,
						...
						code: ({ children }) => (
							<code className="bg-muted text-muted-foreground px-1 py-0.5 rounded text-xs font-mono">{children}</code>
						),
						pre: ({ children }) => (
