			...
			<div className="container mx-auto max-w-7xl text-center space-y-8">
				<div className="space-y-4">
					...
					<Lead className="text-muted-foreground text-lg leading-normal max-w-2xl mx-auto">
						Have questions about the railway concession process? We&apos;re here to help!
					</Lead>
				</div>
				...
				<Paragraph className="text-muted-foreground text-sm">We typically respond within 24 hours</Paragraph>
			</div>
		</section>
	);
};
