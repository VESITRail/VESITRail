...
const Developers = () => {
	return (
		<section id="developers" className="flex flex-col bg-background overflow-x-hidden px-4 md:px-8 py-12">
					...
					{developers.map((developer, index) => (
						...
						>
							<div className="flex justify-between items-start mb-2">
								<h2 className="text-xl font-semibold bg-clip-text">{developer.name}</h2>
