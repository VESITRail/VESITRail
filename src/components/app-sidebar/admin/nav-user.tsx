					...
					<DropdownMenuTrigger asChild>
						...
						>
							<Avatar className="size-8 rounded-lg">
								<AvatarImage alt={data?.user.name || "Admin"} src={data?.user.image || undefined} />
								<AvatarFallback className="rounded-lg">{getUserInitials("Admin", data?.user.name)}</AvatarFallback>
							</Avatar>
					...
					>
						<DropdownMenuLabel className="p-0 font-normal">
							<div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
								<Avatar className="size-8 rounded-lg">
									<AvatarImage src={data?.user.image || undefined} alt={toTitleCase(data?.user.name) || "Admin"} />
									<AvatarFallback className="rounded-lg">{getUserInitials("Admin", data?.user.name)}</AvatarFallback>
								</Avatar>
