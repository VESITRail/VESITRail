...
import { Bell, Mail, Users, Shield, Calendar, Database, FileText } from "lucide-react";
					...
					<div className="space-y-12">
						<div>
							...
							<Paragraph className="text-muted-foreground leading-relaxed">
								Welcome to VESITRail. These Terms of Service (&quot;Terms&quot;) govern your use of our web application
								designed exclusively for VESIT students to apply for and manage railway concessions. By accessing or
								using our service at {siteDomain}, you agree to be bound by these Terms.
							</Paragraph>
						</div>
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Eligibility and Account Registration</Heading2>
							</div>
							...
							<div className="space-y-6">
								<div>
									...
									<List className="space-y-2 text-muted-foreground">
										<li>
											Be a currently enrolled student at VESIT (Vivekanand Education Society&apos;s Institute of
											Technology)
										</li>
								...
								<div>
									...
									<List className="space-y-2 text-muted-foreground">
										...
										<li>One account per student - duplicate accounts are prohibited</li>
									</List>
								</div>
							</div>
						</div>
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Acceptable Use</Heading2>
							</div>

							<Paragraph className="text-muted-foreground mb-4">When using VESITRail, you agree to:</Paragraph>

							<List className="space-y-3 text-muted-foreground mb-6">
								<li>
									<strong>Provide Accurate Information:</strong> Submit truthful and accurate information in all
									applications
								</li>
								<li>
									<strong>Use for Intended Purpose:</strong> Use the service only for legitimate railway concession
									applications
								</li>
								<li>
									<strong>Respect Others:</strong> Not interfere with other users&apos; ability to use the service
								</li>
								<li>
									<strong>Follow Guidelines:</strong> Comply with all VESIT and railway authority guidelines
								</li>
								<li>
									<strong>Report Issues:</strong> Notify us of any bugs, security vulnerabilities, or misuse
								</li>
							</List>

							<Paragraph className="text-muted-foreground mb-4">You agree NOT to:</Paragraph>

							<List className="space-y-2 text-muted-foreground">
								<li>Submit false or fraudulent information</li>
								<li>Create multiple accounts or share your account with others</li>
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Service Description</Heading2>
							</div>
							...
							<div className="space-y-6">
								...
								<div>
									...
									<Paragraph className="text-muted-foreground mb-4">Please note the following limitations:</Paragraph>
									<List className="space-y-2 text-muted-foreground">
										<li>Service availability depends on VESIT administration approval processes</li>
										<li>Railway concession eligibility is subject to railway authority rules</li>
										<li>Application processing times may vary based on verification requirements</li>
										<li>Technical maintenance may temporarily interrupt service availability</li>
									</List>
								</div>
							</div>
						</div>
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Intellectual Property</Heading2>
							</div>
							...
							<div className="space-y-6">
								<div>
									...
									<Paragraph className="text-muted-foreground">
										VESITRail and all related content, features, and functionality are owned by VESIT and are protected
								...
								<div>
									...
									<Paragraph className="text-muted-foreground">
										By uploading documents or providing information, you grant us a limited license to process, store,
										and use your content solely for providing our services. You retain ownership of your personal
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Disclaimers and Limitations</Heading2>
							</div>
							...
							<div className="space-y-6">
								<div>
									...
									<Paragraph className="text-muted-foreground">
										We strive to maintain continuous service availability but cannot guarantee uninterrupted access. The
										service is provided &quot;as is&quot; without warranties of any kind, either express or implied.
									</Paragraph>
								</div>
								...
								<div>
									...
									<Paragraph className="text-muted-foreground">
										VESITRail shall not be liable for any indirect, incidental, special, or consequential damages
										arising from your use of the service. Our total liability shall not exceed the value of services
										provided to you.
									</Paragraph>
								</div>
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Account Termination</Heading2>
							</div>
							...
							<div className="space-y-6">
								<div>
									...
									<Paragraph className="text-muted-foreground">
										You may terminate your account at any time by contacting us. Upon termination, your access to the
										service will be immediately revoked, and your data will be handled according to our Privacy Policy.
									</Paragraph>
								</div>
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Governing Law</Heading2>
							</div>

							<Paragraph className="text-muted-foreground">
								These Terms shall be governed by and construed in accordance with the laws of India. Any disputes
								arising from these Terms or your use of the service shall be subject to the jurisdiction of the courts
						...
						<div>
							<div className="flex items-center gap-3 mb-6">
								...
								<Heading2 className="pb-0! leading-none!">Changes to Terms</Heading2>
							</div>
						...
						<div>
							...
							<Paragraph className="text-sm text-muted-foreground">
								These terms of service are effective as of {lastUpdated} and apply to VESITRail ({siteDomain}), a
								service exclusively for VESIT students.
							</Paragraph>
						</div>
					</div>
				</div>
