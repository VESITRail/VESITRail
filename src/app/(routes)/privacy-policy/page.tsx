          ...
          <div className="space-y-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Paragraph className="text-muted-foreground mb-4">
                    When you register and use VESITRail, we collect the
                ...
                <div>
                  ...
                  <Paragraph className="text-muted-foreground">
                    We use Google OAuth for secure authentication. We only
                    access your VESIT email address and basic profile
                    information necessary for account creation and verification.
                  </Paragraph>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <List className="space-y-3 text-muted-foreground">
                <li>
                  <strong>Application Processing:</strong> To process your
                  railway concession applications and generate digital booklets
                </li>
                <li>
                ...
                <li>
                  <strong>Communication:</strong> To send application status
                  updates and important notifications
                </li>
                <li>
                  <strong>Verification:</strong> To verify your eligibility as a
                  VESIT student
                </li>
                <li>
                ...
                <li>
                  <strong>Compliance:</strong> To comply with legal requirements
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Paragraph className="text-muted-foreground">
                    We share necessary information with VESIT administration and
                    authorized staff for verification, approval, and
                    administrative purposes related to your concession
                    applications.
                  </Paragraph>
                </div>
                ...
                <div>
                  ...
                  <Paragraph className="text-muted-foreground">
                    Required information may be shared with railway authorities
                    as part of the concession application and verification
                    process, in accordance with railway regulations.
                  </Paragraph>
                </div>
            ...
            <div>
              ...
              <Paragraph className="text-muted-foreground mb-4">
                VESITRail uses Firebase Cloud Messaging to send push
                notifications about:
              </Paragraph>
              ...
              <Paragraph className="text-muted-foreground">
                ...
                or disable them entirely through your browser or device
                settings.
              </Paragraph>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Paragraph className="text-muted-foreground">
                    ...
                    management, and basic functionality. These cannot be
                    disabled without affecting the service.
                  </Paragraph>
                </div>
            ...
            <div>
              ...
              <Paragraph className="text-sm text-muted-foreground">
                ...
                to VESITRail ({siteDomain}), a service exclusively for VESIT
                students.
              </Paragraph>
            </div>
          </div>
